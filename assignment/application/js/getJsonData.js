...
$(document).ready(function(){
	 ...
	 $.getJSON('../application/model/data.json', function(jsonObj) {
		...
		//Get the montana main text data
		$('#x3dModelTitle_montana').html('<h2>' + jsonObj.pageTextData[4].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_montana').html('<p>' + jsonObj.pageTextData[4].x3dCreationMethod + '<p>');
		$('#title_montana').html('<h2>' + jsonObj.pageTextData[4].title + '<h2>');
		$('#subTitle_montana').html('<h3>' + jsonObj.pageTextData[4].subTitle + '</h3>');
		$('#description_montana').html('<p>' + jsonObj.pageTextData[4].description + '</p>');
 
		//Get the limon main text data
		$('#x3dModelTitle_limon').html('<h2>' + jsonObj.pageTextData[5].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_limon').html('<p>' + jsonObj.pageTextData[5].x3dCreationMethod + '<p>');
		$('#title_limon').html('<h2>' + jsonObj.pageTextData[5].title + '<h2>');
		$('#subTitle_limon').html('<h3>' + jsonObj.pageTextData[5].subTitle + '</h3>');
		$('#description_limon').html('<p>' + jsonObj.pageTextData[5].description + '</p>');		

		//Get the fresa main text data
		$('#x3dModelTitle_fresa').html('<h2>' + jsonObj.pageTextData[6].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_fresa').html('<p>' + jsonObj.pageTextData[6].x3dCreationMethod + '<p>');
 		$('#title_fresa').html('<h2>' + jsonObj.pageTextData[6].title + '<h2>');
		$('#subTitle_fresa').html('<h3>' + jsonObj.pageTextData[6].subTitle + '</h3>');
		$('#description_fresa').html('<p>' + jsonObj.pageTextData[6].description + '</p>');
